package com.sjexample3.SpringBootDemo3;
...
import com.sjexample3.SpringBootDemo3.repository.UserRepository;
    ...
    CommandLineRunner init(UserRepository userRepository) {
    	return args -> {
            ...
            for (int i = 0; i < 50; i++) {
                ...
                users.add(new User(null ,firstName, lastName, age, activeStatus));
            }
